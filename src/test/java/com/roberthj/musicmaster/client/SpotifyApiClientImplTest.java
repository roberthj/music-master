...
class SpotifyApiClientImplTest {
    ...
    void setup() {
        spotifyApiClient =
                new SpotifyApiClientImpl(httpWebClient, "clientId", "clientSecret");
    }

    @Test
    public void verifyThatWebClientIsCalledWithCorrectUriAndHeaders() throws IOException {
    ...
    private String getMockedTokenResponseJson() {
        return
                "{\"access_token\":\"tokenValue\",\"token_type\":\"Bearer\",\"expires_in\":3600}";
    }
